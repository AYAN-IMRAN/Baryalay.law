...
// ---- hooks (resize observer, image loader, animation loop) ----
    ...
    const renderLogoItem = useCallback(
      (item, key) => (
        ...
        >
          <img
            className={cx(
              "h-[var(--logoloop-logoHeight)] w-auto block object-contain grayscale hover:grayscale-0 hover:scale-105 transition duration-300 ease-in-out",
